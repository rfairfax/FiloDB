...
mod tests {
    ...
    fn test_time_filter_match_all() {
        ...
        let query = AllQuery;
        let collector = TimeRangeFilter::new(&Count, 0, i64::MAX, cache);
        let result = index
            .searcher
    ...
    fn test_time_filter_match_end_filter() {
        ...
        let query = AllQuery;
        let collector = TimeRangeFilter::new(&Count, 0, 2000, cache);
        let result = index
            .searcher
            .search(&query, &collector)
            .expect("Should succeed");
    ...
    fn test_time_filter_match_start_filter() {
        ...
        let query = AllQuery;
        let collector = TimeRangeFilter::new(&Count, 2000, i64::MAX, cache);
        let result = index
            .searcher
            .search(&query, &collector)
            .expect("Should succeed");
    ...
    fn test_time_filter_match_overlap() {
        ...
        let query = AllQuery;
        let collector = TimeRangeFilter::new(&Count, 1000, 2000, cache);
        let result = index
            .searcher
            .search(&query, &collector)
            .expect("Should succeed");
    ...
    fn test_time_filter_match_outside_range() {
        ...
        let query = AllQuery;
        let collector = TimeRangeFilter::new(&Count, 20_000, 20_000, cache);
        let result = index
            .searcher
            .search(&query, &collector)
            .expect("Should succeed");
