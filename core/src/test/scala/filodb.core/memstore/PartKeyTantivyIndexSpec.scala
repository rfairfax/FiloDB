...
class PartKeyTantivyIndexSpec extends AnyFunSpec with Matchers with BeforeAndAfter with PartKeyIndexRawSpec {
  ...
  it("should encode equals queries correctly") {
    ...
    val query = builder.buildQueryWithStartAndEnd(filters, 1234, 4321)
    ...
    query should contain theSameElementsInOrderAs List(1,// Boolean
      ...
      7, // Long Range
      13, 0, // Length 13
      95, 95, 115, 116, 97, 114, 116, 84, 105, 109, 101, 95, 95, // __startTime__
      0, 0, 0, 0, 0, 0, 0, 0, // 0
      -31, 16, 0, 0, 0, 0, 0, 0, // 1234
      1, // Must
      7, // Long Range
      11, 0, // Length 11
      95, 95, 101, 110, 100, 84, 105, 109, 101, 95, 95, // __endTime__
      -46, 4, 0, 0, 0, 0, 0, 0, // 4321
      -1, -1, -1, -1, -1, -1, -1, 127, // Int.MAX
      0) // End boolean
  }
